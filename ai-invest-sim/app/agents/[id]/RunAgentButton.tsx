...
function RunButton({
  ...
  return (
    <button
      ...
      className={
        runType === "rebalance"
          ? "rounded-lg bg-blue-600 px-3 py-2 text-sm text-white hover:bg-blue-700 disabled:bg-slate-700"
          : "rounded-lg bg-slate-100 px-3 py-2 text-sm text-slate-700 hover:bg-blue-100 disabled:bg-slate-100 disabled:text-slate-400"
      }
    >
